...
var context = 'OR CPRS GUI CHART'; // VPR UI CONTEXT
...
//VistaJS.callRpc(logger, configuration, 'ORWPT LAST5', [
//	VistaJS.RpcParameter.literal('S0007'),
//	], printResult);

VistaJS.callRpc(logger, configuration, 'ORWPT LIST ALL', [
	VistaJS.RpcParameter.literal('Patientftl'),
...
//VistaJS.callRpc(logger, configuration, 'VPR GET PATIENT DATA JSON', { '"patientId"': '8', '"domain"': 'allergy' }, printJsonResult);
